...
/// Initialize the ads SDK and request UMP consent (no-op on web).
...
/// Mid-list native ad for search results (after the 4th item).
Widget resultsListAd() => impl.resultsListAd();
